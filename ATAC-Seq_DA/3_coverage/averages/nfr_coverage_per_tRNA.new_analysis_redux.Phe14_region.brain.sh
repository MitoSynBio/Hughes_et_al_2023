...
WT_nfr_out=$outdir/WT_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.txt
WTout=$outdir/WT_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.npz
...
WTnfr_bg=$outdir/WT_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.bedgraph
...
KO_nfr_out=$outdir/Phe11_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.txt
KOout=$outdir/Phe11_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.npz
...
KOnfr_bg=$outdir/Phe11_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.bedgraph
...
KO_nfr_out=$outdir/Phe21_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.txt
KOout=$outdir/Phe21_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.npz

multiBigwigSummary bins -b $KO1_nfr $KO2_nfr $KO3_nfr -o $KOout --outRawCounts $KO_nfr_out -p 12 -bs 1 --region $region

KOnfr_bg=$outdir/Phe21_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.bedgraph
...
KO_nfr_out=$outdir/Phe31_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.txt
KOout=$outdir/Phe31_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.npz

multiBigwigSummary bins -b $KO1_nfr $KO2_nfr $KO3_nfr -o $KOout --outRawCounts $KO_nfr_out -p 12 -bs 1 --region $region

KOnfr_bg=$outdir/Phe31_brain.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe14.bedgraph
