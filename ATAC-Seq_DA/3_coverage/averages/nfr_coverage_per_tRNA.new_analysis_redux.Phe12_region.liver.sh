...
WT_nfr_out=$outdir/WT_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.txt
WTout=$outdir/WT_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.npz

multiBigwigSummary bins -b $WT1_nfr $WT2_nfr $WT3_nfr $WT4_nfr -o $WTout --outRawCounts $WT_nfr_out -p 12 -bs 1 --region $region

WTnfr_bg=$outdir/WT_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.bedgraph
...
KO_nfr_out=$outdir/Phe11_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.txt
KOout=$outdir/Phe11_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.npz
...
KOnfr_bg=$outdir/Phe11_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.bedgraph
...
KO_nfr_out=$outdir/Phe21_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.txt
KOout=$outdir/Phe21_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.npz

multiBigwigSummary bins -b $KO1_nfr $KO2_nfr $KO3_nfr -o $KOout --outRawCounts $KO_nfr_out -p 12 -bs 1 --region $region

KOnfr_bg=$outdir/Phe21_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.bedgraph
...
KO_nfr_out=$outdir/Phe31_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.txt
KOout=$outdir/Phe31_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.npz

multiBigwigSummary bins -b $KO1_nfr $KO2_nfr -o $KOout --outRawCounts $KO_nfr_out -p 12 -bs 1 --region $region

KOnfr_bg=$outdir/Phe31_liver.norm_rpm.NFR.extend.atac_shift.avg.tRNAPhe12.bedgraph
